if (typeof registerPaint === 'function') {
  ...
  class DotGridWorket {
    ...
    parseProps(props) {
      ...
      return {
        dotSize: isUnknown(dotSize) ? parseFloat(dotSize.toString(), 10) || 3 : dotSize.value,
        dotSpacing: isUnknown(dotSpacing) ? parseFloat(dotSpacing.toString(), 10) || 6 : dotSpacing.value,
